...
echo.
echo Copy correct WARTHOG bindfiles...
rem		Change destination username and ensure destination bindings folder is correct...
copy c:\thrustmaster\ed_targetscript_warthog\bindfiles\*.* "c:\users\<USERNAME>\appdata\local frontier developments\elite dangerous\options\bindings\" /y
echo.
